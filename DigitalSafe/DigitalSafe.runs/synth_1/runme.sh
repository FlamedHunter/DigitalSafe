...
HD_PWD='D:/Xilinx/Vivado/DigitalSafe/DigitalSafe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalSafe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DigitalSafe.tcl
