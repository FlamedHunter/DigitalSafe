...
HD_PWD='D:/Xilinx/Vivado/DigitalSafe/DigitalSafe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalSafe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DigitalSafe.tcl -notrace
